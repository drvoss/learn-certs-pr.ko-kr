...
## <a name="become-a-microsoft-certified-trainer"></a>Become a Microsoft Certified Trainer
...
MCT가 되면 다양하고 유용한 리소스를 얻고, MCT 인증을 다운로드하고, 사용 가능한 할인을 확인할 수 있는 개인 맞춤형 대시보드인에 액세스할 수 있습니다.

또한 [MCT Central](https://www.microsoft.com/en-us/learning/mct-central.aspx)에 액세스하여 최신 뉴스를 확인하고, 일자리를 찾고, 전 세계 다른 MCT 회원과 소통하고, MCT 지역 리더에게 연락할 수도 있습니다.

[MCT에게 제공되는 모든 혜택을 살펴보세요.](https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RE23o0Z)

## <a name="requirements-to-become-a-mct"></a><a name="requirements-to-become-mct"></a> MCT 자격 요구 사항

MCT 프로그램은 전세계 곳곳에서 Microsoft 기술에 대한 교육을 제공하는 교육자들을 위한 프로그램입니다. 요건을 충족하는 인증 또는 자격을 보유하고 있고 Microsoft 기술에 관한 교육 제공에 관심이 많다면, 프로그램 신청을 권장합니다.

MCT 프로그램 요구 사항에 대한 자세한 정보는 본 페이지의 [신청 절차](#application-process) 섹션의 MCT 프로그램 가이드 및 MCT 프로그램 계약을 참조하시기 바랍니다.


### <a name="mct-program-entry-requirements"></a>MCT 프로그램 참여 요건

- 현재 MCT 프로그램에 적합한 Microsoft 인증 또는 자격을 보유해야 합니다. (자격 인증 목록은 아래를 참조하세요.)
- 다음 중 한 가지 기관을 통해 강의 기술을 입증해야 합니다.
  - 강의 기술 인증
    - CompTIA CTT+.
    ...
    - Microsoft 고객 서비스 및 지원(CSS) 트레이너 인증.
    - Microsoft 핵심 트레이닝 기술.
    - New Horizons Instructional Skills Certification.
    - PrepMasters USA.
    - Modern Classroom Certified Trainer(MCCT®) [대학 교직원 또는 교수 전용].
    - Certified Virtual Educator [대학 교직원 또는 교수 전용].
    - Sinerji Egitim
...
**참고** MCT 상태를 갱신하시려면 인증 획득일까지 MCT 프로그램 갱신 요건을 충족하셔야 합니다.

## <a name="requirements-to-renew-your-mct-status"></a>MCT 상태 갱신 요구 사항

- 현재 MCT 프로그램에 적합한 Microsoft 인증 또는 자격을 보유해야 합니다. (자격 인증 목록은 아래를 참조하세요.)

- [MTM(Metrics that Matter)](http://www.executiveboard.com/exbd/human-resources/metrics-that-matter/index.page) 측정법 또는 다른 측정도구를 통해 검증된 방법을 사용하여 최소 1개의 교육반을 대상으로 한 교육 경력 요건을 충족해야 합니다.

**참고** 갱신 요건은 변경될 수 있습니다.

## <a name="current-microsoft-certifications-and-qualifications-eligible-for-the-mct-program"></a>MCT 프로그램에 적합한 현재 Microsoft 인증 및 자격 유형
...
- [Microsoft Certified: Azure 솔루션 설계자 전문가](/learn/certifications/azure-solutions-architect)
...
- [Microsoft Office Specialist (MOS)](/learn/certifications/browse/?type=mos): [Master 2016](/learn/certifications/microsoft-office-specialist-master-certification-2016), [Master 2013](/learn/certifications/microsoft-office-specialist-master-certification-2013), [Expert Excel 2016](/learn/certifications/mos-excel-2016-expert), [Expert Excel 2013](/learn/certifications/mos-excel-2013-expert), [Expert Word 2016](/learn/certifications/mos-word-2016-expert), [Expert Word 2013](/learn/certifications/mos-word-2013-expert), [Word Associate (Word 및 Word 2019)](/learn/certifications/mos-word-2019), [Excel Associate (Excel 및 Excel 2019)](/learn/certifications/mos-excel-2019), [PowerPoint Associate (PowerPoint 및 PowerPoint 2019)](/learn/certifications/mos-powerpoint-2019), [Outlook Associate (Outlook 및 Outlook 2019)](/learn/certifications/mos-outlook-2019), [Microsoft Office Specialist: Associate (Office 365 및 Office 2019)](/learn/certifications/microsoft-office-specialist-associate-2019), [Word Expert (Word 및 Word 2019)](/learn/certifications/mos-word-expert-2019), [Excel Expert (Excel 및 Excel 2019)](/learn/certifications/mos-excel-expert-2019), [Access Expert (Access 및 Access 2019)](/learn/certifications/mos-access-expert-2019) 또는 [Microsoft Office Specialist: Expert (Office 365 및 Office 2019)](/learn/certifications/microsoft-office-specialist-expert-2019)
 
**참고** MCT 프로그램에 적격한 Microsoft 인증 및 자격은 변동될 수 있습니다. 모든 새로운 역할 기반 인증은 출시된 후 MCT 프로그램에 대한 자격을 얻게 됩니다. 만료된 인증은 만료일로부터 최대 6개월까지 MCT 프로그램에 대한 자격을 가집니다. 인증 중단에 대해 자세히 알아보려면 [인증 중단](/learn/certifications/retired-certifications)을 방문하세요.

## <a name="application-process"></a><a name="application-process"></a> 신청 절차

MCT가 되고 싶다면 MCT 프로그램 가이드 및 MCT 프로그램 계약을 살펴보고 멤버십 약관을 숙지하시기 바랍니다.
...
온라인 신청은 [MCT 등록 도구](https://mcp.microsoft.com/Authenticate/MCT)에서 할 수 있습니다. MCID(Microsoft Certification ID)와 연결된 개인 Microsoft 계정을 사용하여 MCT 등록 도구에 로그인해야 합니다.

MCT 등록 도구의 용도:

- MCT 프로그램 요건 검토 및 MCT 프로그램 가이드 및 계약에 서명. 응시자가 제공하는 전자 서명은 MCT 이용 약관에 대한 응시자의 동의를 의미합니다.
- 프로필 정보 업데이트. 프로필에 기입하신 정보는 MCT 관련 커뮤니케이션을 위해 사용됩니다.
- 고용 상태 명시. Learning Partner 또는 Microsoft Imagine Academy에 재직 중이신 경우에는 Learning Partner 또는 Microsoft Imagine Academy의 직원 ID 번호를 명시해주시기 바랍니다.
...
Microsoft Office 전문가이며 MCID(Microsoft Certification ID)가 없다면 [customerservices@certiport.com](mailto:customerservices@certiport.com)에 문의하여 발급받으세요.

## <a name="mct-alumni-program"></a>MCT Alumni 프로그램
...
## <a name="mct-alumni-benefits"></a>MCT Alumni 혜택

MCT Alumni 멤버가 되면 귀하의 [인증 대시보드](https://www.microsoft.com/learning/dashboard.aspx)에서 MCT Alumni 컨텐츠의 독점 액세스가 제공됩니다. 뉴스, 이벤트 및 다양한 MCT Alumni 맞춤 리소스를 얻을 수 있으며, 전체 MCT 커뮤니티에 참여하실 수 있는 [MCT Central](https://www.microsoft.com/en-us/learning/mct-central.aspx) 액세스 권한도 함께 제공됩니다.

MCT Alumni 혜택 사항:

- MCT 인증 갱신 및 향후 MCT 프로그램 재등록에 도움이 되는 시험 할인권.
- 시험 준비 및 전문성 개발을 위한 참조 자료를 제공하는 전자책 및 도서 할인 혜택.

## <a name="apply-to-join-the-mct-alumni-program"></a>MCT Alumni 프로그램 가입 신청

MCT Alumni 멤버가 되길 희망하시는 경우, MCT Alumni 프로그램 계약을 살펴보시고 멤버십 약관에 대해 숙지하시기 바랍니다.<br/>

[MCT Alumni 프로그램 계약.](https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RE2XP6W)

### <a name="apply-online"></a>온라인 신청

[MCT 등록 도구](https://mcp.microsoft.com/Authenticate/MCT)를 통해 MCT Alumni 멤버십을 신청하세요.

## <a name="moving-from-mct-alumni-to-mct"></a>MCT Alumni에서 MCT로 전환

MCT Alumni 소속인 경우, MCT 프로그램 교육 실무로 복귀하시면 언제든지 MCT 프로그램에 재가입하실 수 있습니다.

MCT 복귀 요건:

- 본 페이지의 [요구 사항](#requirements-to-become-mct)란에서 설명하는 MCT 프로그램 요구 사항을 충족해야 합니다. MCT 프로그램에 적격한 현재 Microsoft 인증 및 자격 충족여부 확인.
...
## <a name="mct-and-mct-alumni-program-fees"></a>MCT 및 MCT Alumni 프로그램 수수료

[여기를 클릭하여 귀하의 국가/지역의 MCT 프로그램 연회비 및 MCT Alumni 가입 수수료를 확인하시기 바랍니다.](https://www.microsoft.com/en-us/learning/mct-programfees.aspx)

## <a name="mct-support"></a>MCT 지원

MCT 신청, 결제, 혜택 관련 도움이 필요하거나, MCT 프로그램에 대한 일반적인 질문이 있다면 MCT를 위한 중재 포럼에서 지원을 받을 수 있습니다. 자세한 정보는 [인증 지원](/learn/certifications/help)에서 확인하세요.