...
시험 예약과 관련된 문제가 있다면 [Microsoft 인증 지원](https://trainingsupport.microsoft.com/en-us/mcp/forum/mcp_exams-mcp_offer-mcp_eventoffer?sort=LastReplyDate&dir=Desc&tab=All&status=all&mod=&modAge=&advFil=&postedAfter=&postedBefore=&threadType=all&isFilterExpanded=false&page=1)을 통해 도움을 받으세요. 포럼의 조정자는 업무일 하루만에 응답할 것입니다.
...
**Q: 이 제안을 사용하여 몇 회의 시험을 무료로 예약할 수 있나요?**

**A:** 이 제안을 사용하여 적격 시험 1회를 무료로 신청할 수 있습니다. 

**Q: 이 제안을 사용하여 어떤 인증 시험에 응시할 수 있나요?**

**A:** 이 제안에는 모든 Microsoft 기본 사항, 역할 기반, 전문 인증 시험이 포함됩니다. 적격 인증 시험 목록은 제안 세부 정보 페이지의 “[적격 시험](/learn/certifications/microsoft-build-cloud-skills-challenge-2020-free-certification-exam-offer#eligible-exams)” 섹션을 참조하세요.

**Q: Microsoft Ignite에 등록했지만 Cloud Skills Challenge에 등록하거나 완료하지 않은 경우에도 이 제안을 사용할 수 있나요?**

**A:** 아니요, 이 제안은 Microsoft Build에 참여했으며 Cloud Skills Challenge 내 컬렉션 중 하나를 완료한 사람에게만 해당됩니다. 

### <a name="scheduling-your-free-exam"></a>무료 시험 예약 

**Q: 2021년 3월 31일 또는 그 이전에 시험에 응시해야 하나요?**

**A:** 예, 2021년 3월 31일 또는 그 이전에 시험에 응시해야 합니다. 

**Q: 무료 시험을 예약하는 데 문제가 있습니다. 어디에서 지원을 받을 수 있나요?**

**A:** [Microsoft 인증 지원](https://trainingsupport.microsoft.com/en-us/mcp/forum/mcp_exams-mcp_offer-mcp_eventoffer?sort=LastReplyDate&dir=Desc&tab=All&status=all&mod=&modAge=&advFil=&postedAfter=&postedBefore=&threadType=all&isFilterExpanded=false&page=1)에 문의하여 도움을 받을 수 있습니다. 조정자는 업무일 하루만에 응답할 것입니다.
